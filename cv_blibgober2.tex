...
\begin{document}
    ...
    \begin{tablist}
    \item[2022] \tab{}\citeworkingpaper[]{Abi-Hassan2021} (Conditionally Accepted, \textit{Political Analysis})
    ...
    \item[2021] \tab{}\citeworkingpaper{Chen2021} (R\&R, JPART)
    \item[2021] \tab{}\citeworkingpaper{Jerzak2021}
    \item[2020] \tab{}\citeworkingpaper{Libgober2020c}  (R\&R, JPART) %agencyfailure
