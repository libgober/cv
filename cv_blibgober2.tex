...
%	\end{tikzpicture}
    ...
    \item[2023] \tab{}\citeworkingpaper{Carpenter2021} (R\&R, \textit{Perspectives on Politics})
	...
	\item[2023]	\tab{}Institute for Policy Research Program (SURA), \$2,975
	\item[2023]	\tab{}Farrell Fellowship Program, \$7,500.
	\end{tablist}
