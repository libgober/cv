...
%	\end{tikzpicture}
    ...
    \begin{tablist}
    \item[2026] \tab{} \citeworkingpaper{Pashley2025AuditExperiments} (Journal of the Royal Statistical Society: Series A)
    \item[2026]\tab{}\citeworkingpaper{HolverscheidLibgoberPouliot2024} (Accepted, Research and Politics)
    \item[2025] \tab{}\citejournalarticle{FERNANDES2025118607}
    ...
    \begin{tablist}
    \talk{2026}{Who Governs the Association?}{Princeton University, Department of Politics}{Mar 26}
    ...
    \begin{tablist}
    \talk{2026}{Conference on Identity and Inequality}{Princeton}{April 17}
