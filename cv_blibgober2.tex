...
%	\end{tikzpicture}
    ...
    \begin{tablist}
     ...
     \item[2024] \tab{}\citejournalarticle{ChenGober2023}
    ...
    \item[\the\year] \tab{}\citeworkingpaper{CarpenterCollective} (Winner, Herbert Kaufman Award for Best Paper Presented at APSA 2021)
    \item[\the\year] \tab{}\citeworkingpaper{Li2021}
    \end{tablist}

    \subsection*{Other Publications}
    \begin{tablist}
    \item[2024] \tab{}\citechapter{Libgober2024} 
