...
\begin{document}
    ...
    \begin{tablist}
    \item[2022] \tab{}\citeworkingpaper[]{Abi-Hassan2021} (Forthcoming, \textit{Political Analysis})
	...
	\item[2021] \tab{}\citeworkingpaper{Libgober2021} (R\&R, \textit{PLOS: ONE})
    \item[2021] \tab{}\citeworkingpaper{Carpenter2021} 
    \item[2021] \tab{}\citeworkingpaper{Chen2021} (R\&R, \textit{JPART})
    \item[2021] \tab{}\citeworkingpaper{Jerzak2021}
    \item[2020] \tab{}\citeworkingpaper{Libgober2020c}  (R\&R, \textit{JPART}) %agencyfailure
