...
%	\end{tikzpicture}
    ...
    \begin{tablist}
    \item[2025] \tab{}\countthis\citejournalarticle{Omari2025FederalProcurementDataset}
    ...
    \begin{tablist}
    \item[2026] \tab{}\countthis\citechapter{LibgoberKingJacobs}
    ...
    \item[] \citeworkingpaper{Pashley2025AuditExperiments} (R\&R, Journal of the Royal Statistical Society: Series A)
    \item[] \citeworkingpaper{Libgober2025InstitutionalConstraints} (R\&R, Social Science \& Medicine)
    \item[] \citeworkingpaper{HolverscheidLibgoberPouliot2024} (R\&R, Research and Politics)
    ...
    \begin{tablist}
    \talk{2025}{White Shoes, Hidden Hands}{UC Berkeley, Department of Political Science}{Oct  23}
